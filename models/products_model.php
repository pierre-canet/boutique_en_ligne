...
function get_all_products($limit = 20, $offset = 0)
{
    ...
    return db_select($query, ['limit' => $limit, 'offset' => $offset]);
}
...
function get_products_by_category_direct($category_id, $limit = 20, $offset = 0)
{
    ...
    return db_select($query, ['category_id' => $category_id, 'limit' => $limit, 'offset' => $offset]);
}
...
function search_products($search, $limit = 8)
{
    ...
    return db_select($query, ['search' => "%$search%"], ['limit' => $limit]);
}
